...
import io.confluent.developer.schema.TypedSerde.typedSerializer
...
object Producer extends App with TypedSerde with Configuration {
  ...
  private val bookSerializer: Serializer[Book] = typedSerializer[Book]
