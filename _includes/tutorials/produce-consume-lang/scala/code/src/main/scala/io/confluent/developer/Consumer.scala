...
import io.confluent.developer.schema.TypedSerde.typedDeserializer
...
object Consumer extends cask.MainRoutes with TypedSerde with Configuration {
  ...
  new Thread(() => {
    ...
    val bookDeserializer: Deserializer[Book] = typedDeserializer[Book]
