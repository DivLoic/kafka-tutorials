...
class ConsumerSpec extends KafkaFlatSpec with TypedSerde {
  ...
  val bookSerializer: Serializer[Book] = TypedSerde.typedSerializer[Book]
  val bookDeserializer: Deserializer[Book] = TypedSerde.typedDeserializer[Book]
